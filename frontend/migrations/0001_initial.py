    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_img', models.ImageField(blank=True, null=True, upload_to='lead_and_customer_companylogo')),
                ...
                ('status', models.CharField(choices=[('Fresh', 'Fresh'), ('Call Back', 'Call Back'), ('Do Not Disturb', 'Do Not Disturb'), ('Follow up', 'Follow up'), ('Proposed', 'Proposed'), ('Not Interested', 'Not Interested'), ('Hold', 'Hold'), ('Closed', 'Closed')], max_length=15)),
                ...
                ('reffral_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.leadtable')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.location')),
                ('company_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.orgtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(verbose_name=datetime.datetime(2024, 8, 19, 17, 43, 55, 672995))),
